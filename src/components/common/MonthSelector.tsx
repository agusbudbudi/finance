...
export const MonthSelector: React.FC<MonthSelectorProps> = ({
  ...
  return (
    <div
      className={`flex items-center gap-3 bg-white dark:bg-white/5 backdrop-blur-md px-2 py-2 pr-4 rounded-lg border border-gray-200 dark:border-white/10 shadow-lg  shadow-black/5 ${className}`}
    >
