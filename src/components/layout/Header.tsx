        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              >
                <div className="w-9 h-9 rounded-xl overflow-hidden border-2 border-gray-100 dark:border-white/10 bg-primary-50 flex items-center justify-center text-primary-600 font-bold uppercase shrink-0">
                  <img
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <div className="w-10 h-10 rounded-xl overflow-hidden border-2 border-gray-100 dark:border-white/20 shrink-0">
                <img
                  src={`https://ui-avatars.com/api/?name=${displayName}&background=f0f7ff&color=3069fe&bold=true`}
                  alt="Profile"
                  className="w-full h-full object-cover"
